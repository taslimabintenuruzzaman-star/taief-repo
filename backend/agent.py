...
class MorosAGI:
    def __init__(self) -> None:
        self.intents: list[tuple[re.Pattern[str], str]] = [
            ...
            (re.compile(r"\b(who are you|what are you|your name|introduce|কে তুমি|তুই কে|তোমার নাম)\b", re.I), "identity"),
            (re.compile(r"\b(publick?\s+apis?|which api|api list|uplinks?)\b", re.I), "catalog"),
            (re.compile(r"\b(hello|hi|hey|good morning|good evening|good afternoon|wake up|হ্যালো|হাই|সালাম)\b", re.I), "greet"),
            (re.compile(r"\b(thank|cheers|appreciate)\b", re.I), "thanks"),
            (re.compile(r"\b(weather|temperature|forecast|raining|hot outside|আবহাও(?:য়া|য়া)|তাপমাত্রা)\b", re.I), "weather"),
            ...
            (re.compile(r"\b(what time|current time|clock|time is it|সময়|সময়|কয়টা|কয়টা)\b", re.I), "time"),
